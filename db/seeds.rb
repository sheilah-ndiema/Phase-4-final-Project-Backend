...
user1 = User.create(username:"Gizem Killa", password: "12345")
user2 = User.create(username:"Marco Pontius",password: "12345")
user3 = User.create(username:"Vadim Mirza",password: "12345")
user4 = User.create(username:"Isidora Ragnher",password: "12345")
